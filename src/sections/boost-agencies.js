          ...
          <Flex sx={styles.col}>
            <Box sx={styles.content}>
              <Box sx={styles.titleBox}>
                <Heading as="h3">
                  Boost your skills by being a member of Hack Club SIGCE
                </Heading>
                {/* <Text as="p">
              ...
              <Box as="ul" sx={styles.list}>
                ...
                <Text as="li">
                  Competitions, to test your knowledge and compete with the best
                </Text>
                <Text as="li">
                  Hands on experience of fields like AI, Web Dev, Graphics.
                </Text>
              </Box>
            </Box>
          </Flex>
