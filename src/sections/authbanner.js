    ...
    <Box sx={styles.banner} id="banner">
      <Container sx={styles.container}>
        <Grid sx={styles.grid}>
          ...
          <Box sx={styles.image}>
            <Image src={'https://img.freepik.com/free-vector/online-registration-sign-up-with-man-sitting-near-smartphone_268404-95.jpg?w=1920'} alt="" />
...
const styles = {
  banner: {
    pt: ['110px', null, null, null, '150px', '190px'],
  ...
  image: {
    img: {
      ...
      right: ['0', null, null, null, null, '-40px'],
      maxWidth: ['110%', null, null, null, null, null, 'none'],
    },
  },
  partner: {
    display: 'flex',
